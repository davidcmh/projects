...
<embed id="demo-tiger" type="image/svg+xml" style="width: 400px; height: 400px; border:1px solid black; float: left;"
       src="tiger.svg"/>
<embed id="demo-tiger2" type="image/svg+xml" style="width: 400px; height: 400px; border:1px solid red; "
       src="tiger.svg"/>
