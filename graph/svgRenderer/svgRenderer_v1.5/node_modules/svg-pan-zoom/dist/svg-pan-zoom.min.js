...
!function t(e, o, n) {
  ...
  3: [function (t, e) {
    var o = t("./svg-utilities"), n = t("./utilities"), i = function (t, e) {
      this.init(t, e)
    };
    i.prototype.init = function (t, e) {
      this.viewport = t, this.options = e, this.originalState = {zoom: 1, x: 0, y: 0}, this.activeState = {
        zoom: 1,
        x: 0,
        y: 0
      ...
      var t = this.viewport.getBoundingClientRect(), e = t.width / this.getZoom(), o = t.height / this.getZoom();
      ...
      if (this.options.center) {
        var o = .5 * (this.options.width - (this.viewBox.width + 2 * this.viewBox.x) * t.a), n = .5 * (this.options.height - (this.viewBox.height + 2 * this.viewBox.y) * t.a);
        t.e = o, t.f = n
      }
      ...
      if (e || o) {
        if (e && this.options.beforeZoom(this.getRelativeZoom(), this.computeRelativeZoom(t.a)) === !1 && (t.a = t.d = this.activeState.zoom, e = !1), o) {
          var i = this.options.beforePan(this.getPan(), {x: t.e, y: t.f}), s = !1, r = !1;
  ...
  4: [function (t, e) {
    var o = t("./uniwheel"), n = t("./control-icons"), i = t("./utilities"), s = t("./svg-utilities"), r = t("./shadow-viewport"), a = function (t, e) {
      this.init(t, e)
    }, l = {
    ...
    a.prototype.init = function (t, e) {
      ...
      if (this.eventListeners = {
        ...
        this.options.customEventsHandler.init({svgElement: this.svg, instance: this.getPublicInstance()});
      ...
      for (var i in this.eventListeners)this.svg.addEventListener(i, this.eventListeners[i], !1);
      ...
      if (!this.options.mouseWheelZoomEnabled) {
        ...
        }, o.on(this.svg, this.wheelListener, !1), this.options.mouseWheelZoomEnabled = !0
      }
    }, a.prototype.disableMouseWheelZoom = function () {
      this.options.mouseWheelZoomEnabled && (o.off(this.svg, this.wheelListener, !1), this.options.mouseWheelZoomEnabled = !1)
      ...
      if (this.options.zoomEnabled && "none" === this.state) {
        ...
        var i = this.svg.getScreenCTM().inverse(), r = s.getEventPoint(t, this.svg).matrixTransform(i), a = Math.pow(1 + this.options.zoomScaleSensitivity, -1 * e);
      ...
      var i = this.viewport.getCTM(), s = e.matrixTransform(i.inverse()), r = this.svg.createSVGMatrix().translate(s.x, s.y).scale(t).translate(-s.x, -s.y), a = i.multiply(r);
      ...
      if (this.options.preventMouseEventsDefault && (t.preventDefault ? t.preventDefault() : t.returnValue = !1), "pan" === this.state && this.options.panEnabled) {
        var e = s.getEventPoint(t, this.svg).matrixTransform(this.firstEventCTM.inverse()), o = this.firstEventCTM.translate(e.x - this.stateOrigin.x, e.y - this.stateOrigin.y);
      ...
      var t = this.viewport.getViewBox(), e = .5 * (this.width - (t.width + 2 * t.x) * this.getZoom()), o = .5 * (this.height - (t.height + 2 * t.y) * this.getZoom());
      ...
      for (var e in this.eventListeners)this.svg.removeEventListener(e, this.eventListeners[e], !1);
    ...
    var u = [], h = function (t, e) {
      ...
      for (var n = u.length - 1; n >= 0; n--)if (u[n].svg === o)return u[n].instance.getPublicInstance();
      return u.push({svg: o, instance: new a(o, e)}), u[u.length - 1].instance.getPublicInstance()
    };
    e.exports = h
  }, {"./control-icons": 2, "./shadow-viewport": 3, "./svg-utilities": 5, "./uniwheel": 6, "./utilities": 7}],
  5: [function (t, e) {
    var o = t("./utilities"), n = "unknown";
  ...
  6: [function (t, e) {
    e.exports = function () {
      ...
      function e(t, e) {
        for (var o = 0; o < c.length; o++)if (c[o].element === t && c[o].capture === e)return c[o].fn;
        return function () {
        }
      }

      function o(t, e) {
        for (var o = 0; o < c.length; o++)if (c[o].element === t && c[o].capture === e)return c.splice(o, 1)
      }
  ...
  7: [function (t, e) {
    ...
    e.exports = {
      extend: function (t, e) {
        ...
        if (void 0 === t.clientX || null === t.clientX)if (t.clientX = 0, t.clientY = 0, void 0 !== t.changedTouches && t.changedTouches.length) {
          if (void 0 !== t.changedTouches[0].clientX)t.clientX = t.changedTouches[0].clientX, t.clientY = t.changedTouches[0].clientY; else if (void 0 !== t.changedTouches[0].pageX) {
        ...
        if (void 0 !== e && null !== e) {
          var o = t.timeStamp - e.timeStamp, n = Math.sqrt(Math.pow(t.clientX - e.clientX, 2) + Math.pow(t.clientY - e.clientY, 2));
          return 250 > o && 10 > n
        }
        return !1
